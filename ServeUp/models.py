...
class Jed(models.Model):
    ...
    id_jedilni_list = models.ForeignKey('JedilniList', models.DO_NOTHING,
                                        db_column='id_jedilni_list')
...
class JediNarocila(models.Model):
    id_jed = models.ForeignKey(Jed, models.DO_NOTHING, db_column='id_jed',
                               primary_key=True)
    id_narocila = models.ForeignKey('Narocilo', models.DO_NOTHING,
                                    db_column='id_narocila')

    class Meta:
        managed = False
        db_table = 'jedi_narocila'
        unique_together = (
        ('id_jed', 'id_narocila'), ('id_jed', 'id_narocila'),)
...
class Narocilo(models.Model):
    ...
    id_restavracija = models.ForeignKey('Restavracija', models.DO_NOTHING,
                                        db_column='id_restavracija')
    id_uporabnik = models.ForeignKey('Uporabnik', models.DO_NOTHING,
                                     db_column='id_uporabnik')
...
class Naslov(models.Model):
    ...
    postna_stevilka = models.ForeignKey('Posta', models.DO_NOTHING,
                                        db_column='postna_stevilka')
...
class Posta(models.Model):
    postna_stevilka = models.DecimalField(primary_key=True, max_digits=4,
                                          decimal_places=0)
...
class Vsebuje(models.Model):
    id_jed = models.ForeignKey(Jed, models.DO_NOTHING, db_column='id_jed',
                               primary_key=True)
    id_sestavine = models.ForeignKey(Sestavine, models.DO_NOTHING,
                                     db_column='id_sestavine')

    class Meta:
        managed = False
        db_table = 'vsebuje'
        unique_together = (
        ('id_jed', 'id_sestavine'), ('id_jed', 'id_sestavine'),)
